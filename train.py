...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', default='cifar10', help='cifar10 | lsun | imagenet | folder | lfw| piarstreet ')
    ...
    elif opt.dataset == "piarstreet":
        transform = transforms.Compose([transforms.Scale(opt.imageSize),
                                        transforms.CenterCrop(opt.imageSize),
                                        transforms.ToTensor(),
                                        transforms.Normalize((0.5, 0.5, 0.5), (0.5, 0.5, 0.5))])

        dataset = dset.ImageFolder(root='./dataset/train1', transform=transform)
    assert dataset
